# project 8 - less efficient
# duplicate the call/function/return translations
...
def translate_function_command(command_list, asm_file):
    ...
    asm_file.write(
        ...
        "M=1                              \n"
        "                                 \n"
        f"(LOOP_{label_counter})          \n"
        f"@i_{label_counter}              \n"
        "D=M                              \n"
        f"@{command_list[2]}              \n"
        "D=D-A                            \n"
        f"@STOP_{label_counter}           \n"
...
def translate_return_command(asm_file):
    """
    translate a function command into the asm file
    :param asm_file: the output asm file
    :return: none
...
def translate_file(lines_list, vm_file_name, asm_file, already_translated_a_file):
    ...
    for line in lines_list:
        ...
        if command_list[0] == "label":  # label command
            ...
            translate_return_command(asm_file)
